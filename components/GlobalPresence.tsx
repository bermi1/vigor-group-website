  ...
  return (
    <section className="relative isolate overflow-hidden bg-graphite-900 py-20 text-white sm:py-24">
      <div aria-hidden="true" className="absolute inset-0 -z-10">
        <div className="absolute -left-24 top-1/2 h-96 w-96 -translate-y-1/2 rounded-full bg-graphite-500/20 blur-3xl" />
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {p.isHq && (
                    <span className="rounded-full bg-brand-400 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-graphite-900">
                      HQ
                    </span>
                  )}
                </div>
              </div>
              <p className="mt-4 text-sm leading-relaxed text-graphite-100/75">{p.note}</p>
            </RevealItem>
          ))}
        </RevealGroup>
      </div>
